...
class InlineFinger(QComponent):
    ...
    def make(self):
        ...
        p.cap_width = p.prime_width / (2*N-1)
        ...
        second_cpw_top = draw.LineString([[0, -p.prime_width / 2],
                                          [0, -p.cap_distance]])
        second_cpw_top = draw.rotate(second_cpw_top, 180)
        ...
        c_items = [
            second_cpw_top, second_cpw_bottom, cap_body, cap_etch
        ]
        c_items = draw.rotate(c_items, p.orientation, origin=(0, 0))
        c_items = draw.translate(c_items, p.pos_x, p.pos_y)
        [second_cpw_top, second_cpw_bottom, cap_body,
         cap_etch] = c_items
        ...
        second_pin_list_top = second_cpw_top.coords
        ...
        self.add_pin('second_start',
                     points=np.array(second_pin_list_top),
                     width=p.second_width,
                     input_as_norm=True)
